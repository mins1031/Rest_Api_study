...
public class EventControllerTest {
    ...
    public void queryEvents() throws Exception{
        ...
        //_embedded의 eventList의 [0]번쨰에 self링크가 있는가?를 뭇는 로직
                ;
    }
    ...
    @Test
    @TestDescription("없는 이벤트 조회했을때 404 응답받기")
    public void getEvent404() throws Exception{
        this.mockMvc.perform(get("/api/events/1111"))
    ...
    public void updateEvent()throws Exception {
        ...
        this.mockMvc.perform(put("/api/events/{id}",event.getId())
                ...
                .andExpect(jsonPath("_links.self").exists())
                .andExpect(jsonPath("_links.profile").exists())
                .andExpect(jsonPath("_links.get-an-event").exists())
    ...
    public void updateEvent400_Wrong() throws Exception {
        ...
        this.mockMvc.perform(put("/api/events/{id}", event.getId())
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .param("Event", objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isBadRequest())
                ;
    }
